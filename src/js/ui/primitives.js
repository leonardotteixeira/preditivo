...
export const btnPrimary =
  'inline-flex items-center justify-center rounded-md border border-transparent bg-zinc-100 px-4 py-2.5 text-sm font-semibold text-zinc-950 shadow-sm transition hover:bg-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-futoro-accent';

export const btnSecondary =
  'inline-flex items-center justify-center rounded-md border border-futoro-line bg-transparent px-3 py-2 text-sm font-medium text-zinc-200 transition hover:border-zinc-600 hover:bg-futoro-raised';
...
export const cardShell =
  'rounded-lg border border-futoro-line bg-futoro-surface p-5 shadow-panel';

export const badgeNeutral =
  'inline-flex items-center rounded border border-futoro-line bg-futoro-void px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-zinc-500';
...
export const progressTrack =
  'flex h-2 overflow-hidden rounded-sm border border-futoro-line bg-futoro-void';
